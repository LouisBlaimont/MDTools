...
<div class="flex-[1] flex flex-col gap-[15px] h-full pl-3 bg-gray-50">
    <div class = "relative resize overflow-auto border border-gray-300" bind:this={div4}>
    ...
    <div class="absolute w-2 h-2 bg-gray-500 bottom-0 right-0 cursor-nwse-resize" on:mousedown={(e) => startResize(e, div4)}></div>
</div>