...
<main class="flex flex-col md:flex-row justify-center w-11/12 lg:w-3/4 mx-auto mt-6 p-6 text-[14px]">
  ...
  <form class="border-3 rounded-lg w-full md:w-2/3 lg:w-1/2 p-6 mx-auto bg-gray-100 shadow-lg">
    ...
    <div class="space-y-3">
      <label for="email" class="block font-semibold text-lg">Adresse e-mail:</label>
      ...
      <button class="bg-teal-500 text-white py-3 mt-4 rounded-lg w-full hover:bg-teal-600 text-lg" type="submit">Envoyer le lien de réinitialisation</button>
    </div>
